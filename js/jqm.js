...
// setTimeout(function () {
//   $('#crossslide img').css({ 'transform': 'scale(2)', 'transition': 'all 8' })
// }, 700)
...
$('.imgFix').click(function () {
  ...
  // $('.entryHeader').removeClass('fadeOutLeft fadeInLeft').css({ 'display': 'none' })
  // $('.fixMenu').removeClass('fadeInLeft fadeOutLeft')
  // $('.fixMenu').removeClass('fadeInLeft')
  // $('.fixMenu').addClass('fadeInLeft')
  // setTimeout(function () {
  //   $('.entryHeader').removeClass('fadeInRight fadeOutRight').css({ 'display': 'none', 'position': 'fixed' })
  // }, 700)
})
